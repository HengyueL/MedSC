...
class CTSeriesInt(object):
    ...
    def _initialize(self):
        ...
        #    raise RuntimeError('Start and end do not match number of slices: {} (start={}, end={}, slices={}'.format(self.dcm_dir, self.absolute_range[0], self.absolute_range[1], len(self)))
