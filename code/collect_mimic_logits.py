...
def get_mimic_race_loader():
    ...
    MIMIC_originl = pd.read_csv('/home/jusun/shared/For_HY/datasets/MIMIC/MIMIC_originl.csv') #Other as the test data

    test_data = MIMIC_originl
...
def main(args):
    ...
    log_root = os.path.join(".", "raw_data_collection", "MIMIC", name_str, corr_name)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="/panfs/jay/groups/15/jusun/shared/For_HY/models/MIMIC/raw/best_model_raw.pth"
    )
